...
const Services = () => {
  ...
  Turning complex ideas into powerful web applications.
</h2>

<p className="text-lg text-white/60 max-w-xl mx-auto">
  Delivering end-to-end software solutions with modern frameworks,
  robust backend architecture, and scalable cloud deployment.
</p>
          ...
          {services.slice(0, 2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[200px] flex flex-col">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-primary/0 group-hover:to-primary/5 rounded-3xl transition-colors duration-300 pointer-events-none" />
                </div>
              </FadeIn>
            );
          })}
          ...
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={300 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all h-full">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-[#A8FF8D] transition-colors">
                      {service.title}
                    </h3>
