          ...
          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-2.5 px-[18px] py-[11px] mb-8 bg-linear-to-r  from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full">
                ...
                <span className="text-xs md:text-sm text-white tracking-[1.2]">
            ...
            <FadeIn delay={200}>
              <p className="text-lg- text-white/70 max-w-[550px] mb-8">
                I design and develop scalable enterprise applications using
.NET Core, Angular, SQL Server, and AWS. With strong expertise
in REST API integration, cloud deployment, and performance
optimization, I build reliable systems that improve efficiency,
reduce downtime, and deliver measurable business impact.
              </p>
            </FadeIn>

            <FadeIn delay={300}>
              <button className="inline-flex items-center gap-0  mb-12 group" onClick={() => scrollToSection('contact')}>
