...
const Contacts = () => {
  ...
  const templateParams = {
    to_name: "Your Name", // Replace with your name (recipient)
    from_name: formData.name, // Sender name from form
    message: `Email: ${formData.email}\n\n${formData.message}`, // Include sender email + message
  };

  // Send email using EmailJS
  emailjs.send(
    'service_untioem',       // Your EmailJS Service ID
    'template_cf0m0zd',      // Your EmailJS Template ID
    templateParams,
    '1g0DnRZGxunriugc5'      // Your EmailJS Public Key
  )
  .then((response) => {
        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
              ...
              <span className="text-sm text-primaryfont-medium tracking-wider uppercase">Get In Touch</span>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl  text-white placeholder-white/40 focus:ring-primary focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl  text-white placeholder-white/40 focus:ring-primary focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 resize-none"
