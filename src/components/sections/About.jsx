...
import { SiAngular,SiPostman } from "react-icons/si";
...
const About = () => {
  ...
  { name: 'Core', icon: AiOutlineDotNet },
          ...
          <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-white/70 leading-relaxed">
                      Designing scalable full-stack applications using .NET Core, Angular, SQL Server, and cloud technologies. Experienced in REST API integration, database optimization, and enterprise system architecture.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                ...
                <p className="text-sm text-white/70 leading-relaxed">
                  Following SOLID principles, writing maintainable and well-structured code, conducting code reviews, and ensuring long-term scalability and readability across projects.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                ...
                <p className="text-sm text-white/70 leading-relaxed">
                  Improving system efficiency through optimized SQL queries, API performance tuning, background service automation, and streamlined CI/CD pipelines.
                </p>
              </div>
            </div>
              ...
              <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                <div className="grid grid-cols-3 gap-6 text-center">
                  <div>
                    ...
                    <div className="text-xs text-white/60">Cloud Deployment</div>
                  </div>

                  <div>
                    <div className="text-2xl font-bold text-primary mb-1">CI/CD</div>
                    <div className="text-xs text-white/60">Automated Pipelines</div>
                  </div>

                  <div>
                    <div className="text-2xl font-bold text-primary mb-1">Agile</div>
                    <div className="text-xs text-white/60">Team Collaboration</div>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full max-w-4xl">
            {skills.map((skills, index) => (
              <div key={index} className="group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-2xl p-6 flex flex--col items-center justify-center gap-3 transition-all duration-300 hover-scale-105">
                <skills.icon className="text-3xl text-primary" />
